export default {
  ...
  loadingoverlay: {
    class: ["absolute", "top-0 left-0", "z-20", "flex items-center justify-center", "w-full h-full", "bg-surface-100/40 dark:bg-surface-900/40", "transition duration-200"]
  },
  loadingicon: {
  ...
  footer: {
    class: ["font-bold", "border-t-0 border-b border-x-0", "p-4", "bg-surface-0 dark:bg-surface-900", "border-surface-200 dark:border-surface-700", "text-surface-700 dark:text-white/80"]
  },
  column: {
    headercell: ({ context, props }) => ({
          class: [
            ...
            // Spacing
            (context == null ? void 0 : context.size) === "small" ? "py-[0.375rem] px-2" : (context == null ? void 0 : context.size) === "large" ? "py-[0.9375rem] px-5" : "py-3 px-4",
            // Color
            ...
            "border-surface-200 dark:border-surface-700 ",
            // States
            { "hover:bg-surface-100 dark:hover:bg-surface-800/50": (props.sortable === "" || props.sortable) && !(context != null && context.sorted) },
    ...
    bodycell: ({ props, context, state, parent }) => ({
          class: [
            ...
            // Spacing
            { "py-[0.375rem] px-2": (context == null ? void 0 : context.size) === "small" && !state.d_editing },
            { "py-[0.9375rem] px-5": (context == null ? void 0 : context.size) === "large" && !state.d_editing },
            { "py-3 px-4": (context == null ? void 0 : context.size) !== "large" && (context == null ? void 0 : context.size) !== "small" && !state.d_editing },
    ...
    filteroverlay: {
      class: ["absolute top-0 left-0", "border-0 dark:border", "rounded-md", "shadow-md", "min-w-[12.5rem]", "bg-surface-0 dark:bg-surface-900", "text-surface-800 dark:text-white/80", "dark:border-surface-700"]
    },
    ...
    filterrowitem: ({ context }) => ({
          class: [
            ...
            { "bg-surface-0 dark:bg-surface-900 text-surface-700 dark:text-white/80": !(context != null && context.highlighted) },
            { "bg-primary-highlight text-primary-highlight-inverse": context == null ? void 0 : context.highlighted },
            //States
            { "hover:bg-surface-100 dark:hover:bg-[rgba(255,255,255,0.03)]": !(context != null && context.highlighted) },
            { "hover:text-surface-700 hover:bg-surface-100 dark:hover:text-white dark:hover:bg-[rgba(255,255,255,0.03)]": !(context != null && context.highlighted) },
            "focus-visible:outline-none focus-visible:outline-offset-0 focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400",
            // Transitions
            "transition-shadow",
            "duration-200",
    ...
    filteroperator: {
      class: ["rounded-t-md", "text-surface-700 dark:text-white/80", "bg-surface-0 dark:bg-surface-700"]
    },
    ...
    filteraddrulebutton: {
      root: {
        class: ["relative", "items-center inline-flex text-center align-bottom justify-center", "text-sm py-[0.4375rem] px-[0.875rem] w-full", "rounded-md", "bg-transparent border-transparent", "text-primary", "hover:bg-primary-300/20", "transition duration-200 ease-in-out", "cursor-pointer overflow-hidden select-none"]
      },
      label: {
    ...
    filterremovebutton: {
      root: {
        class: ["relative", "items-center inline-flex text-center align-bottom justify-center", "text-sm py-[0.4375rem] px-[0.875rem] w-full mt-2", "rounded-md", "bg-transparent border-transparent", "text-red-500 dark:text-red-400", "hover:bg-red-300/20", "transition duration-200 ease-in-out", "cursor-pointer overflow-hidden select-none"]
      },
      label: {
        class: "flex-auto grow-0"
      },
    ...
    filterclearbutton: {
      root: {
        class: ["relative", "items-center inline-flex text-center align-bottom justify-center", "text-sm py-[0.4375rem] px-[0.875rem]", "rounded-md", "text-primary-500 border border-primary", "hover:bg-primary-300/20", "transition duration-200 ease-in-out", "cursor-pointer overflow-hidden select-none"]
      }
    },
    filterapplybutton: {
      root: {
        class: ["relative", "items-center inline-flex text-center align-bottom justify-center", "text-sm py-[0.4375rem] px-[0.875rem]", "rounded-md", "text-primary-inverse", "bg-primary", "hover:bg-primary-hover hover:border-primary-hover", "transition duration-200 ease-in-out", "cursor-pointer overflow-hidden select-none"]
      }
    },
    ...
    rowRadiobutton: {
      ...
      box: ({ props }) => ({
              class: [
                ...
                { "bg-surface-0 dark:bg-surface-950": !props.disabled },
                {
                  ...
                  "border-primary": props.value == props.modelValue && props.value !== void 0 && !props.disabled
                },
                {
                  ...
                  "peer-hover:border-primary-hover": !props.disabled && props.value == props.modelValue && props.value !== void 0,
                  "peer-hover:[&>*:first-child]:bg-primary-600 dark:peer-hover:[&>*:first-child]:bg-primary-300": !props.disabled && props.value == props.modelValue && props.value !== void 0,
      ...
      input: {
        class: ["peer", "w-full ", "h-full", "absolute", "top-0 left-0", "z-10", "p-0", "m-0", "opacity-0", "rounded-md", "outline-none", "border-1 border-surface-200 dark:border-surface-700", "appearance-none", "cursor-pointer"]
      },
      icon: ({ props }) => ({
              class: [
                "block",
